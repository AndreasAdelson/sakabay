  ...
  <div>
                ...
                <div class="stat-widget-five">
                  ...
                  <div class="stat-content">
                    <div class="text-left dib">
                      <div class="stat-text">
                        Publiez votre CV<span class="count" />
                      </div>
    ...
    <div class="user-menu dropdown-menu">
      <a
        class="nav-link"
        href="#"
      ><i class="fa fa-user" />My Profile</a>

      <a
        class="nav-link"
        href="#"
      ><i class="fa fa-bell-o" />Notifications <span class="count">13</span></a>

      <a
        class="nav-link"
        href="#"
      ><i class="fa fa-cog" />Settings</a>
