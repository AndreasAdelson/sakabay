 ...
 */
final class Version20200919161625 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE company (id INT AUTO_INCREMENT NOT NULL COMMENT \'Identifiant technique d\'\'un company\', utilisateur_id INT NOT NULL COMMENT \'Identifiant technique d\'\'un user\', id_category INT NOT NULL COMMENT \'Identifiant technique d\'\'un category\', id_companystatut INT NOT NULL COMMENT \'Identifiant technique d\'\'un CompanyStatut\', name VARCHAR(191) NOT NULL, num_siret VARCHAR(14) NOT NULL, url_name VARCHAR(100) NOT NULL, UNIQUE INDEX UNIQ_4FBF094FFB88E14F (utilisateur_id), INDEX IDX_4FBF094F5697F554 (id_category), INDEX IDX_4FBF094F96856F23 (id_companystatut), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB COMMENT = \'Entité représentant un Company.\' ');
