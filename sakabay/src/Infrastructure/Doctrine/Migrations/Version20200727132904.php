...
final class Version20200727132904 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE fonction (id INT NOT NULL, code VARCHAR(50) NOT NULL, description VARCHAR(255) DEFAULT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('CREATE TABLE "group" (id INT NOT NULL, name VARCHAR(50) NOT NULL, code VARCHAR(255) DEFAULT NULL, PRIMARY KEY(id))');
        $this->addSql('CREATE UNIQUE INDEX uniqueGroupCode ON "group" (code)');
        $this->addSql('COMMENT ON TABLE "group" IS \'Entité technique regroupant les rôles de l\'\'application. On associe un utilisateur à un groupe pour donner à cet utilisateur les droits du groupe.\'');
        $this->addSql('COMMENT ON COLUMN "group".id IS \'Identifiant technique de la group\'');
        $this->addSql('COMMENT ON COLUMN "group".name IS \'Nom du groupe\'');
        $this->addSql('COMMENT ON COLUMN "group".code IS \'Code du groupe\'');
        ...
        $this->addSql('COMMENT ON COLUMN groupes_roles.id_group IS \'Identifiant technique de la group\'');
        $this->addSql('COMMENT ON COLUMN groupes_roles.id_role IS \'Identifiant technique d\'\'un role\'');
        $this->addSql('CREATE TABLE role (id INT NOT NULL, name VARCHAR(300) DEFAULT NULL, code VARCHAR(100) DEFAULT NULL, PRIMARY KEY(id))');
        $this->addSql('COMMENT ON TABLE role IS \'Entité représentant une Role.\'');
        ...
        $this->addSql('ALTER TABLE groupes_roles ADD CONSTRAINT FK_5F256D89834505F5 FOREIGN KEY (id_group) REFERENCES "group" (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
        ...
        $this->addSql('ALTER TABLE utilisateurs_groupes ADD CONSTRAINT FK_59950F8C834505F5 FOREIGN KEY (id_group) REFERENCES "group" (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
    }
